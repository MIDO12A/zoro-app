...
(async () => {
  let r = await q("SELECT column_name, is_nullable FROM information_schema.columns WHERE table_schema='public' AND table_name='financial_idempotency_keys' ORDER BY ordinal_position");
  console.log(r);
})();
