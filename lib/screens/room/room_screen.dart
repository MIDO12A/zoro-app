              ...
              onFinished: () {
                if (mounted) {
                  setState(() {
                    ...
                    _giftFlightIconUrl = '';
                    _giftFlightTargets = [];
                    // الآن بعد وصول الهدية إلى المقعد المحدد يشتغل عرض الهدية الكبيرة
                    _showGiftAnim = (_giftAnimAsset != null && _giftAnimAsset!.isNotEmpty);
                  });
